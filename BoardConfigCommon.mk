...
BOARD_KERNEL_CMDLINE := console=ttyMSM,115200,n8 androidboot.console=ttyMSM androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci androidboot.boot_devices=soc/7824900.sdhci
